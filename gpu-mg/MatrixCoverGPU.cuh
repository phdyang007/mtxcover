...
__device__ void delete_rows_and_columns(
    ...
    const int *next_col, int *deleted_rows, int *deleted_cols,
    short *deleted_col_id, const int search_depth, const int selected_row_id,
...
__device__ void get_largest_value(int *vec, const int vec_length, int *max = 0);
